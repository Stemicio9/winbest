...
Datore _$DatoreFromJson(Map<String, dynamic> json) {
  return Datore(
    ...
    listaaziende: (json['listaaziende'] as List)
        ?.map((e) =>
            e == null ? null : Azienda.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$DatoreToJson(Datore instance) => <String, dynamic>{
      ...
      'listaaziende': instance.listaaziende,
    };
