...
String appName = 'Inserisci carta';
String fieldReq = 'Campo richiesto';
String numberIsInvalid = 'Il numero di carta è corretto';
String pay = 'Aggiungi metodo';
...
class PaymentCard {
  ...
  CreditCard toCreditCard(){
    CreditCard creditCard = CreditCard(brand: type.toString(), number: number, name: name,
        expMonth: month,expYear: year,cvc: cvv.toString());
    return creditCard;
  }
